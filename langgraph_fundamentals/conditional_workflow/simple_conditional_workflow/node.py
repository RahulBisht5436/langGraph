...
createEssayPrompt = PromptTemplate(
    template="""
You are an expert essay writer.

Write a well-structured, clear, and informative essay on the following topic:
...
1. Introduction
   ...
   - Present the main idea or thesis of the essay.

2. Main Body
   - Divide the essay into multiple logical paragraphs.
   - Each paragraph should focus on one main idea.
   - Explain each idea clearly and in sufficient detail.
   - Provide relevant examples, facts, or real-world scenarios where appropriate.
   - Maintain a logical flow between paragraphs.
   - Discuss different perspectives or arguments when relevant.
   - Avoid repeating the same ideas.

3. Conclusion
   - Summarize the key points discussed in the essay.
   - Reinforce the main argument or thesis.
   - Provide a meaningful final thought or takeaway.

Writing Guidelines:
- Use clear, professional, and grammatically correct English.
- Maintain a formal and academic tone.
- Ensure the essay has a logical structure.
- Use appropriate transitions between paragraphs.
- Avoid unnecessary repetition and filler content.
- Do not use unsupported or fabricated statistics.
- Keep the discussion relevant to the given topic.
- Use headings only when they improve readability.
- The essay should be original and coherent.

Length:
- Write approximately 500–700 words.
- Focus on quality, depth, clarity, and logical reasoning rather than unnecessarily increasing the word count.

Now write the complete essay on the given topic.
""",
